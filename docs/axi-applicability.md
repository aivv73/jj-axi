...
| 8 | Content first | Applicable | Running `jj-axi` with no arguments is exactly equivalent to `jj-axi inspect`, providing the live current-change, diff-stat, conflict, and divergence home view. | None. |
